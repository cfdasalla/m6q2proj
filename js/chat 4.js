...
let messages = [
	...
	["m", "Maybe another example will help?", right],
	["m", "Sure, let's have another one.", left, 1500],
	["m", "Now, let's have \\(\\displaystyle\\frac{\\mathrm{d}}{\\mathrm{d}x}\\left(" + r2.latex() + "\\right)\\).", left, 5000],
	...
	["m", "I’ll give you one more question. This time, the numerator will be degree 2.", left, 3500],
