...
let messages = [
	...
	["m", "Now we have our two products, \\(" + operatePoly(r1a, r1b.derivative(), "m").latex() + "\\) and \\(" + operatePoly(r1b, r1a.derivative(), "m").latex() + "\\).", left, 6000],
	...
	["m", "Let’s have \\(\\frac{\\mathrm{d}}{\\mathrm{d}x}(" + r2a.latex() + ")(" + r2b.latex() + ")\\).", left, 4000],
	...
	["m", "Now we have our two products, \\(" + operatePoly(r2a, r2b.derivative(), "m").latex() + "\\) and \\(" + operatePoly(r2b, r2a.derivative(), "m").latex() + "\\).", left, 6000],
	...
	["m", "Let’s have \\(\\frac{\\mathrm{d}}{\\mathrm{d}x}(" + r3a.latex() + ")(" + r3b.latex() + ")\\).", left, 4000],
